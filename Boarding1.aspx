<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Boarding1.aspx.cs" Inherits="WebApplication1.User1" %>
        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card">
            <div class="card-body p-4 p-md-5">
              <h3 class="auto-style1">Boarding Form</h3>
                ...
                <div class="row">
                  ...
                  <div class="row">
                      <div class="col-md-6 mb-4">
                          <div class="form-outline">
                              <label class="form-label" >Select Boarding days/week/month</label>
